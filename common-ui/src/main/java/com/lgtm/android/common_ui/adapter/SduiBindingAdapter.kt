...
@BindingAdapter("setLayerBackground")
fun View.setBackground(theme: SduiTheme) {
    when (theme) {
    ...
    when (theme) {
        SduiTheme.LIGHT -> setBackgroundColor(
            ContextCompat.getColor(
                this.context,
                com.lgtm.android.common_ui.R.color.gray_2
            )
        )
        ...
        SduiTheme.DARK -> setBackgroundColor(
            ContextCompat.getColor(
                this.context,
                com.lgtm.android.common_ui.R.color.gray_3
            )
        )
    }
}
