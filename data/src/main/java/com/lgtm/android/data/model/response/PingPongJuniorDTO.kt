...
data class PingPongJuniorDTO(
    ...
    fun toVO() : PingPongJuniorVO {
        return PingPongJuniorVO(
            ...
            missionHistory = missionHistory?.map { it.toVO() } ?: throw NullPointerException("missionHistory is null"),
            missionName = missionName ?: throw NullPointerException("missionName is null"),
            processStatus = processStatus ?: throw NullPointerException("processStatus is null"),
            reviewId = reviewId,
            techTagList = techTagList?.map { it.toVO() } ?: throw NullPointerException("techTagList is null"),
